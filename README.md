...
### Iteration 12a: User Authentication with Auth0
...
### Iteration 12b: Authenticated call to backend (Profile)
...
### Iteration 13: Secure product API calls and role-based UI
...
### Iteration 14: API base URL configuration via `.env` files
